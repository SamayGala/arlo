      ...
      <Wrapper>
        <ContentWrapper>
          ...
          <InstructionsWrapper>
            ...
            <OL>
              <li>
                Confirm that you are looking at the correct ballot for the batch and position. If the ballot was not located, select <strong>Ballot Not Found at the top of the screen.</strong>
              </li>
              <li>
                For each contest, select all the candidate/choices which you see marked on the paper ballot. Select <strong>Blank Vote</strong> if the voter did not make any selections. Select <strong>Not on Ballot</strong> if the contest does not appear on the ballot.
              </li>
              <li>Once all votes are recorded, <strong>Submit Selections</strong> and proceed to the next ballot until all ballots have been audited.</li>
            </OL>
          </InstructionsWrapper>
        </ContentWrapper>
      </Wrapper>
