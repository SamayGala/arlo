...
describe('Batch Comparison', () => {
    ...
    it('Failure cases', () => {
        ...
        // Total Ballots Cast less than total of Candidates
        ...
        // clear total ballots and update proper total
        cy.findByLabelText(/Total Ballots for Contest/).clear().type('5320')
        ...
        // upload invalid Candidate Totals by Batch file
